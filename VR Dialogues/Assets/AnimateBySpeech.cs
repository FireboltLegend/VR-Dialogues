...
public class AnimateBySpeech : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        syncPath = Path.Combine(Application.dataPath, "sync.txt");
    }
    ...
    void Update()
    {
        ...
        if (File.Exists(filePath))
        {
            ...
            oldString = nocap;
            String avatarname = this.gameObject.name == "Avatar 1" ? "ezio" : "kirtana";
            ...
            {
                nocap += content.Contains("1") ? " kirtana:" : " ezio:";
            }
            if(newString)
            {
            switch (nocap)
            {
                case string when (nocap.Contains("happy") || nocap.Contains("good") || nocap.Contains("excellent") || nocap.Contains("nice!") || nocap.Contains("cool!") || nocap.Contains("perfect!") || nocap.Contains("great") || nocap.Contains("fantastic")) && nocap.Contains(avatarname + ":"):
                    animator.SetBool("Happy", true);
                    break;
                case string when (nocap.Contains("...") || nocap.Contains("oh,") || nocap.Contains("oh.") || nocap.Contains("no") || nocap.Contains("low-key") || nocap.Contains("apologies") || nocap.Contains("apology") || animator.GetBool("Sad")) && nocap.Contains(avatarname + ":"):
                ...
                case string when (nocap.Contains("sorry") || nocap.Contains("sad") || nocap.Contains("sad") || nocap.Contains("shame") || nocap.Contains("oh...")) && nocap.Contains(avatarname + ":"):
                    ...
                    break;
                case string when (nocap.Contains("alright") || nocap.Contains("thank you") || nocap.Contains("thank goodness") || nocap.Contains("thanks") || nocap.Contains("cool") || nocap.Contains("chill") || nocap.Contains("good") || nocap.Contains("great") || animator.GetBool("Happy")) && nocap.Contains(avatarname + ":"):
